...
public class AssignProgramController implements Initializable {
    ...
    void loadTableData() throws Exception {
        ...
        for (ProgramDetailsDto therapistTherapyProgramDto : therapistTherapyProgramDtos) {
            ...
            programDetailsTm.setPatient(therapistTherapyProgramDto.getPatient());
            programDetailsTm.setTherapyProgram(therapistTherapyProgramDto.getTherapyProgram());
            programDetailsTm.setTherapyProgramName(therapistTherapyProgramDto.getTherapyProgramName());
            programDetailsTm.setFee(String.valueOf(therapistTherapyProgramDto.getCurrentPaymentStatus()));
            programDetailsTm.setRegisterDate(therapistTherapyProgramDto.getRegisterDate());

            therapistTherapyProgramTms.add(programDetailsTm);
        }
